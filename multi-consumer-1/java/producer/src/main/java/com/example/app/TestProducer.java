...
public class TestProducer {
    ...
    private final static String TOPIC1 = "topic-aa";
    private final static String TOPIC2 = "topic-bb";
    ...
    public static void main(String... args) throws Exception {
        ...
        for (int i = 0; i < NUM_THREADS; i++)
            executorService.execute(new TestDataReporter(producer, TOPIC1));
            executorService.execute(new TestDataReporter(producer, TOPIC2));
    }
